Name = "omybuntuBackgroundSelector"
NamePretty = "Omybuntu Background Selector"
Cache = false
...
function GetEntries()
  ...
  local theme_name_file = io.open(home .. "/.config/omybuntu/current/theme.name", "r")
  ...
  local dirs = {
    home .. "/.config/omybuntu/current/theme/backgrounds",
  }
  if theme_name then
    table.insert(dirs, home .. "/.config/omybuntu/backgrounds/" .. theme_name)
  end
      ...
      for background in handle:lines() do
        ...
        if filename and not seen[filename] then
          ...
          table.insert(entries, {
            ...
            Value = background,
            Actions = {
              activate = "omybuntu-theme-bg-set " .. ShellEscape(background),
            },
            Preview = background,
            PreviewType = "file",
          })
