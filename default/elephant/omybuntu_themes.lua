--
-- Dynamic Omybuntu Theme Menu for Elephant/Walker
--
Name = "omybuntuthemes"
NamePretty = "Omybuntu Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/omybuntu/themes"
  local omybuntu_path = os.getenv("OMYBUNTU_PATH") or ""
  local default_theme_dir = omybuntu_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "omybuntu-theme-set " .. theme_name,
            },
          })
        end
      end
