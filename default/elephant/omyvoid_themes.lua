--
-- Dynamic Omyvoid Theme Menu for Elephant/Walker
--
Name = "omyvoidthemes"
NamePretty = "Omyvoid Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/omyvoid/themes"
  local omyvoid_path = os.getenv("OMYVOID_PATH") or ""
  local default_theme_dir = omyvoid_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "omyvoid-theme-set " .. theme_name,
            },
          })
        end
      end
